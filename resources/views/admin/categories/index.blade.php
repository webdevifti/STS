...
@section('scripts')
    <script>
        $('.editBtn').click(function() {
            ...
            var form_action = "{{ route('admin.categories.update', ':contentId') }}";
        ...
        $('.statusBtn').click(function() {
            ...
            var action = "{{ route('admin.category.update.status', ':contentId') }}";
        ...
        $('.deleteBtn').click(function() {
            var modal = $('#delete');
            var content = $(this).data('content');
            var form_action = "{{ route('admin.categories.destroy', ':contentId') }}";
            form_action = form_action.replace(':contentId', content.id);
