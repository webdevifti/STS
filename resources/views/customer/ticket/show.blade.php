                ...
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        <div class="card-body p-2">
                            ...
                            @php
                                $files = !empty($ticket->files_attachments)
                                    ? json_decode($ticket->files_attachments, true)
                                    : [];
                    ...
                    @if ($ticket->status != 'closed')
                        <div class="card mt-2">
                            ...
                            <div class="card-body">
                                <form action="{{ route('customer.tickets.response', $ticket->id) }}" method="POST">
                                    @csrf
...
@section('scripts')
    <script>
        $('.deleteBtn').click(function() {
            ...
            var form_action = "{{ route('customer.tickets.destroy', ':contentId') }}";
